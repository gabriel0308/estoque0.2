...
class FillPermissionsForFabricante extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFabricante constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.fabricante',
            'admin.fabricante.index',
            'admin.fabricante.create',
            'admin.fabricante.show',
            'admin.fabricante.edit',
            'admin.fabricante.delete',
        ]);
