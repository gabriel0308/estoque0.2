...
class FillPermissionsForAnalistum extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAnalistum constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.analistum',
            'admin.analistum.index',
            'admin.analistum.create',
            'admin.analistum.show',
            'admin.analistum.edit',
            'admin.analistum.delete',
        ]);
