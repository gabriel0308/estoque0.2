...
class FillPermissionsForComputador extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForComputador constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.computador',
            'admin.computador.index',
            'admin.computador.create',
            'admin.computador.show',
            'admin.computador.edit',
            'admin.computador.delete',
        ]);
